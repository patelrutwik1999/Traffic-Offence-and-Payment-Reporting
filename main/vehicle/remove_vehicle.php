        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Remove Vehicle &nbsp</h2>
                </div>
                <div class="card-body">
                    <form method="POST" action="main/vehicle/remove.php" enctype="multipart/form-data" onsubmit="return validateNumber(this)">
                        <?php 
                            if (isset($_SESSION['updated'])) {
                        ?>
                        <div class="alert alert-success" id="alert" style="margin-right: 150 px">
                            <strong>Success!</strong> Vehicle Removed
                        </div>
                        <?php
                        ...
                        ?>
                                <div class="alert alert-success" id="alert" style="margin-right: 150 px">
                                    <strong>Failure!</strong> Vehicle Cannot be moved.      
                                </div>   
                        <?php
                        unset($_SESSION['not updated']);
                            }
                            elseif (isset($_SESSION['not updated desc'])) 
                            {
                        ?>
                                <div class="alert alert-success" id="alert" style="margin-right: 150 px">
                                    Vehicle Not Added
                        ...
                        <?php
                        unset($_SESSION['not updated desc']);
                            }
                            elseif (isset($_SESSION['not exist'])) {
                        ?>
                                <div class="alert alert-success" id="alert" style="margin-right: 150 px">
                                    Vehicle Doesnot Exist
                                </div>    
                        <?php
                        unset($_SESSION['not exist']);
                            }
                        ?>
                        <div class="form-row m-b-55">
                            ...
                            <div class="value">
                                <div class="row row-space">
                                    ...
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <button class="btn btn--radius-2 btn--red" style="height: 50px;" type="submit">Remove</button>
