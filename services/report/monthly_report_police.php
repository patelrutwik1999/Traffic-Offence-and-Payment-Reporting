...
<div class="container">
    ...
    <?php
      ...
      /*  $sql = "select vehicle_number, memo_id, amount, date_time from memo_details where police_id = '$p_id' and date_time between '$from_date' and '$to_date'";
        ...
        $sql1 = "select vehicle_number, memo_id, amount, date_time from memo_details where police_id = '$p_id' and date_time between '$from_date' and '$to_date'";
