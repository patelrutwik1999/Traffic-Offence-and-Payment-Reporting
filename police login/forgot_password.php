	...
	<body>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					<div id="login">
						<p class="top"><img style="margin-left:25%;" class="top" src="img/login.png"><span style="margin:20%;"></span></p><br>
						<form name="login_form" method="POST" action="police login/retrieve_password.php" onsubmit="return validate()">
							<label style="color:#141414;font-size:1.7rem;width:100%;">Police I.D</label>
							<input title="police identification number" id="input" type="text" name="police_id" autofocus="true" required="true"><br><br>
