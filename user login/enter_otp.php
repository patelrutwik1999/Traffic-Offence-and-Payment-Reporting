	...
	<head>
		...
		<script type="text/javascript">
			function resend_otp(){
        		...
        		xmlhttp.open("POST","../user_login/resend_otp.php", true);
        		xmlhttp.send();
			...
			if(!pattern.test(number)){
				alert("Enter a valid otp Number.");
				return false;
			}
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div id="login">
						...
						<form name="login_form" method="POST" action="user login/validate_login.php"  >
							...
							<input id="button" type="submit" value="Submit" onclick="return validate()">	
						</form>
